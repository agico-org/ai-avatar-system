...
const FEATURES = [
  {
    ...
    description:
      "Claude & GPT-4 drive natural conversations with context-aware, cached prompts.",
  ...
  },
  {
    ...
    title: "Voice Cloning",
    description:
      "Chatterbox Multilingual clones any voice from a 10-second sample in 23 languages.",
  ...
  },
  {
    ...
    description:
      "MuseTalk V1.5 produces photorealistic lip-sync video aligned to the spoken audio.",
  ...
  },
  {
    ...
    description:
      "WebSocket streams tokens, audio, and video chunk-by-chunk for low first-byte latency.",
  ...
  },
  {
    ...
    description:
      "Whisper STT + Chatterbox TTS support 23 languages end-to-end.",
  ...
  },
  {
    ...
    title: "Privacy-First",
    description:
      "Self-host everything — your photos, voices, and conversations stay on your infra.",
        ...
        {view === "home" && (
          <div className="animate-fade-in">
            ...
            <section className="relative flex flex-col items-center justify-center min-h-[calc(100vh-4rem)] px-6 text-center overflow-hidden">
              ...
              >
                Upload a photo, clone a voice, and have real-time AI-powered
                conversations with photorealistic lip-sync animations. Powered
                by Claude, Whisper, Chatterbox, and MuseTalk.
              </p>
            ...
            <section className="px-6 pb-24 max-w-7xl mx-auto">
              <div className="text-center mb-14">
                ...
                <p className="text-gray-400 text-lg max-w-2xl mx-auto">
                  A complete stack — from voice cloning to lip-sync video —
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {FEATURES.map(
                  ({ icon: Icon, title, description, color, glow }) => (
                    <div
                      key={title}
          ...
          <div className="max-w-7xl mx-auto px-6 py-10 animate-fade-in">
            <div className="mb-8">
              ...
              <p className="text-gray-400">
                Upload photos and manage your avatar collection.
              </p>
            </div>
        ...
        {view === "voice" && (
          <div className="max-w-4xl mx-auto px-6 py-10 animate-fade-in">
            <div className="mb-8">
              ...
              <p className="text-gray-400">
                Clone voices and manage your voice library.
              </p>
            </div>
        ...
        {view === "chat" && selectedAvatar && (
          <div className="max-w-7xl mx-auto px-6 py-10 animate-fade-in">
            <div className="mb-6">
              ...
              <p className="text-gray-400">
                Talk to your AI avatar in real time.
              </p>
            </div>
            <ChatInterface
